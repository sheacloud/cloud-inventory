...
resource "aws_glue_catalog_table" "aws_elasticache_cache_clusters" {
  ...
  storage_descriptor {
    ...
    columns {
      name       = "cache_nodes"
      type       = "array<struct<cache_node_create_time:timestamp,cache_node_id:string,cache_node_status:string,customer_availability_zone:string,customer_outpost_arn:string,endpoint:struct<address:string,port:int>,parameter_group_status:string,source_cache_node_id:string>>"
      comment    = ""
      parameters = {}
    }
    columns {
