...
resource "aws_glue_catalog_table" "aws_redshift_clusters" {
  ...
  storage_descriptor {
    ...
    columns {
      ...
      type       = "array<struct<defer_maintenance_end_time:timestamp,defer_maintenance_identifier:string,defer_maintenance_start_time:timestamp>>"
      comment    = ""
      parameters = {}
    }
    columns {
    ...
    columns {
      ...
      type       = "struct<request_time:timestamp,reserved_node_exchange_request_id:string,source_reserved_node_count:int,source_reserved_node_id:string,source_reserved_node_type:string,status:string,target_reserved_node_count:int,target_reserved_node_offering_id:string,target_reserved_node_type:string>"
      comment    = ""
      parameters = {}
    }
    columns {
