...
type DhcpOptions struct {
	DhcpConfigurations []*DhcpConfiguration `bson:"dhcp_configurations,omitempty" dynamodbav:"dhcp_configurations,omitempty" json:"dhcp_configurations,omitempty" diff:"dhcp_configurations"`
	DhcpOptionsId      string               `bson:"dhcp_options_id,omitempty" dynamodbav:"dhcp_options_id,omitempty" inventory_primary_key:"true" json:"dhcp_options_id,omitempty" diff:"dhcp_options_id,identifier"`
