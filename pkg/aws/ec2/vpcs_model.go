...
var customVpcModelPostprocessingFuncs []func(x *VpcModel) = []func(x *VpcModel){}
var customVpcModelFuncsLock sync.Mutex

func registerCustomVpcModelPostprocessingFunc(f func(x *VpcModel)) {
...
func VpcDataSource(ctx context.Context, client *ec2.Client, reportTime time.Time, storageConfig storage.StorageContextConfig, storageManager *storage.StorageManager) error {
