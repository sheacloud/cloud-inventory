...
type NetworkAcl struct {
	Associations []*NetworkAclAssociation `parquet:"name=associations,type=MAP,convertedtype=LIST" json:"associations" diff:"associations"`
	Entries      []*NetworkAclEntry       `parquet:"name=entries,type=MAP,convertedtype=LIST" json:"entries" diff:"entries"`
...
func (x *NetworkAcl) GetReportTime() int64 {
	return x.ReportTime
}
