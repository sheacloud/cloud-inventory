...
// @Failure      400
// @Router       /inventory/aws/lambda/filesystems [get]
func ListFunctions(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	...
	s3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "lambda", "filesystems"}, *params.ReportDate, params.GetRequestTimeSelection(), s3Client, new(lambda.FunctionConfiguration))
	if err != nil {
...
// @Failure      400
// @Failure 	 404
// @Router       /inventory/aws/lambda/filesystems/{function_arn} [get]
...
// @Failure      400
// @Router       /diff/aws/lambda/filesystems [get]
func DiffMultiFunctions(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	...
	startS3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "lambda", "filesystems"}, *params.StartReportDate, params.GetRequestStartTimeSelection(), s3Client, new(lambda.FunctionConfiguration))
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
	...
	endS3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "lambda", "filesystems"}, *params.EndReportDate, params.GetRequestEndTimeSelection(), s3Client, new(lambda.FunctionConfiguration))
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
...
// @Success      200  {array}   routes.Diff
// @Failure      400
// @Router       /diff/aws/lambda/filesystems/{function_arn} [get]
