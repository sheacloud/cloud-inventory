...
func GetLoadBalancersMetadata(c *gin.Context, dao db.DAO) {
	...
	reportTimes, err := dao.AWS().ElasticLoadBalancing().GetLoadBalancerReportTimes(c, reportDate)
	if err != nil {
...
func ListLoadBalancers(c *gin.Context, dao db.DAO) {
	...
	selectedTime, err := dao.AWS().ElasticLoadBalancing().GetReferencedLoadBalancerReportTime(c, params.ReportDateTime, *params.TimeSelection, params.TimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	results, err := dao.AWS().ElasticLoadBalancing().ListLoadBalancers(c, *selectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
...
func GetLoadBalancer(c *gin.Context, dao db.DAO) {
	...
	result, err := dao.AWS().ElasticLoadBalancing().GetLoadBalancer(c, *selectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}
...
func DiffMultiLoadBalancers(c *gin.Context, dao db.DAO) {
	...
	startSelectedTime, err := dao.AWS().ElasticLoadBalancing().GetReferencedLoadBalancerReportTime(c, params.StartReportDateTime, *params.StartTimeSelection, params.StartTimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	startResults, err := dao.AWS().ElasticLoadBalancing().ListLoadBalancers(c, *startSelectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}

	endSelectedTime, err := dao.AWS().ElasticLoadBalancing().GetReferencedLoadBalancerReportTime(c, params.EndReportDateTime, *params.EndTimeSelection, params.EndTimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	endResults, err := dao.AWS().ElasticLoadBalancing().ListLoadBalancers(c, *endSelectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
...
func DiffSingleLoadBalancer(c *gin.Context, dao db.DAO) {
	...
	startObject, err := dao.AWS().ElasticLoadBalancing().GetLoadBalancer(c, *startSelectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
	...
	endObject, err := dao.AWS().ElasticLoadBalancing().GetLoadBalancer(c, *endSelectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
