...
func GetTransitGatewayRouteTablesMetadata(c *gin.Context, dao db.ReaderDAO) {
	...
	reportTimes, err := dao.GetAwsEC2TransitGatewayRouteTableReportTimes(c, reportDate.UnixMilli())
	if err != nil {
...
func ListTransitGatewayRouteTables(c *gin.Context, dao db.ReaderDAO) {
	...
	selectedTime, err := dao.GetReferencedAwsEC2TransitGatewayRouteTableReportTime(c, params.ReportDateUnixMilli, *params.TimeSelection, params.TimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	results, err := dao.ListAwsEC2TransitGatewayRouteTables(c, *selectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
...
func GetTransitGatewayRouteTable(c *gin.Context, dao db.ReaderDAO) {
	...
	result, err := dao.GetAwsEC2TransitGatewayRouteTable(c, *selectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}
...
func DiffMultiTransitGatewayRouteTables(c *gin.Context, dao db.ReaderDAO) {
	...
	startSelectedTime, err := dao.GetReferencedAwsEC2TransitGatewayRouteTableReportTime(c, params.StartReportDateUnixMilli, *params.StartTimeSelection, params.StartTimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	startResults, err := dao.ListAwsEC2TransitGatewayRouteTables(c, *startSelectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}

	endSelectedTime, err := dao.GetReferencedAwsEC2TransitGatewayRouteTableReportTime(c, params.EndReportDateUnixMilli, *params.EndTimeSelection, params.EndTimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	endResults, err := dao.ListAwsEC2TransitGatewayRouteTables(c, *endSelectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
...
func DiffSingleTransitGatewayRouteTable(c *gin.Context, dao db.ReaderDAO) {
	...
	startObject, err := dao.GetAwsEC2TransitGatewayRouteTable(c, *startSelectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
	...
	endObject, err := dao.GetAwsEC2TransitGatewayRouteTable(c, *endSelectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
