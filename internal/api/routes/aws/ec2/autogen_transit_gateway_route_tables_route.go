...
// GetTransitGatewayRouteTablesMetadata godoc
...
// @Failure      400
// @Router       /metadata/aws/ec2/transit_gateway_route_tables [get]
func GetTransitGatewayRouteTablesMetadata(c *gin.Context, dao db.DAO) {
	...
	reportTimes, err := dao.AWS().EC2().GetTransitGatewayRouteTableReportTimes(c, reportDate)
	if err != nil {
	...
	c.IndentedJSON(200, routes.AwsResourceMetadata{
		...
		IdField:   "transit_gateway_route_table_id",
...
// ListTransitGatewayRouteTables godoc
...
// @Security     ApiKeyAuth
// @Success      200  {object}   ListTransitGatewayRouteTablesResponse
// @Failure      400
// @Router       /inventory/aws/ec2/transit_gateway_route_tables [get]
func ListTransitGatewayRouteTables(c *gin.Context, dao db.DAO) {
	...
	selectedTime, err := dao.AWS().EC2().GetReferencedTransitGatewayRouteTableReportTime(c, params.ReportDateTime, *params.TimeSelection, params.TimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	results, err := dao.AWS().EC2().ListTransitGatewayRouteTables(c, *selectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}

	c.IndentedJSON(200, ListTransitGatewayRouteTablesResponse{
		TransitGatewayRouteTables: results,
	})
}

// GetTransitGatewayRouteTable godoc
...
// @Produce      json
// @Param        report_date query string false  "Which date to pull data from. Current date by default" Format(date)
// @Param        transit_gateway_route_table_id path string true "The transit_gateway_route_table_id of the TransitGatewayRouteTable to retrieve"
// @Param		 account_id query string false  "A specific account to pull data from. All accounts by default"
// @Param		 region query string false  "A specific region to pull data from. All regions by default"
// @Param		 time_selection query string false  "How to select the time range to pull data from. 'latest' by default" Enums(latest, before, after, at)
// @Param		 time_selection_reference query string false  "The reference time to use when selecting the time range to pull data from. Only used when time_selection is 'before', 'after', or 'at'." Format(dateTime)
// @Security     ApiKeyAuth
// @Success      200  {object}   ec2.TransitGatewayRouteTable
// @Failure      400
// @Failure 	 404
// @Router       /inventory/aws/ec2/transit_gateway_route_tables/{transit_gateway_route_table_id} [get]
func GetTransitGatewayRouteTable(c *gin.Context, dao db.DAO) {
	var params routes.AwsQueryParameters
	if err := c.BindQuery(&params); err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	...
	id, err := url.QueryUnescape(c.Param("transit_gateway_route_table_id"))
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}
	...
	result, err := dao.AWS().EC2().GetTransitGatewayRouteTable(c, *selectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}
...
// DiffMultiTransitGatewayRouteTables godoc
...
// @Failure      400
// @Router       /diff/aws/ec2/transit_gateway_route_tables [get]
func DiffMultiTransitGatewayRouteTables(c *gin.Context, dao db.DAO) {
	...
	startSelectedTime, err := dao.AWS().EC2().GetReferencedTransitGatewayRouteTableReportTime(c, params.StartReportDateTime, *params.StartTimeSelection, params.StartTimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	startResults, err := dao.AWS().EC2().ListTransitGatewayRouteTables(c, *startSelectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}

	endSelectedTime, err := dao.AWS().EC2().GetReferencedTransitGatewayRouteTableReportTime(c, params.EndReportDateTime, *params.EndTimeSelection, params.EndTimeSelectionReference)
	if err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	}

	endResults, err := dao.AWS().EC2().ListTransitGatewayRouteTables(c, *endSelectedTime, params.AccountId, params.Region, nil, nil)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
...
// DiffSingleTransitGatewayRouteTable godoc
...
// @Success      200  {array}   routes.Diff
// @Failure      400
// @Router       /diff/aws/ec2/transit_gateway_route_tables/{transit_gateway_route_table_id} [get]
func DiffSingleTransitGatewayRouteTable(c *gin.Context, dao db.DAO) {
	var params routes.AwsDiffParameters
	if err := c.BindQuery(&params); err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	...
	startObject, err := dao.AWS().EC2().GetTransitGatewayRouteTable(c, *startSelectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
	...
	endObject, err := dao.AWS().EC2().GetTransitGatewayRouteTable(c, *endSelectedTime, id)
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
	...
	if startObject == nil && endObject == nil {
		c.AbortWithStatusJSON(404, gin.H{"error": "No TransitGatewayRouteTable found with transit_gateway_route_table_id " + id})
		return
	} else {
