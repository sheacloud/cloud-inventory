...
func GetTransitGatewayPeeringAttachmentsMetadata(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	reportDate := c.Query("report_date")
	if reportDate == "" {
		reportDate = time.Now().UTC().Format("2006-01-02")
	}

	s3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "ec2", "transit_gateway_peering_attachments"}, reportDate, indexedstorage.RequestTimeSelection{}, s3Client, new(ec2.TransitGatewayPeeringAttachment))
	if err != nil {
...
func ListTransitGatewayPeeringAttachments(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	...
	s3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "ec2", "transit_gateway_peering_attachments"}, *params.ReportDate, params.GetRequestTimeSelection(), s3Client, new(ec2.TransitGatewayPeeringAttachment))
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
	...
	if params.AccountId != nil || params.Region != nil {
		...
		for _, result := range results {
			obj := result.(*ec2.TransitGatewayPeeringAttachment)
...
func GetTransitGatewayPeeringAttachment(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	var params routes.AwsQueryParameters
	if err := c.BindQuery(&params); err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
...
func DiffMultiTransitGatewayPeeringAttachments(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	...
	startS3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "ec2", "transit_gateway_peering_attachments"}, *params.StartReportDate, params.GetRequestStartTimeSelection(), s3Client, new(ec2.TransitGatewayPeeringAttachment))
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
	...
	endS3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "ec2", "transit_gateway_peering_attachments"}, *params.EndReportDate, params.GetRequestEndTimeSelection(), s3Client, new(ec2.TransitGatewayPeeringAttachment))
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	}
...
func DiffSingleTransitGatewayPeeringAttachment(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	var params routes.AwsDiffParameters
	if err := c.BindQuery(&params); err != nil {
		c.AbortWithStatusJSON(400, gin.H{"error": err.Error()})
		return
	...
	var startObject *ec2.TransitGatewayPeeringAttachment
	startS3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "ec2", "transit_gateway_peering_attachments"}, *params.StartReportDate, params.GetRequestStartTimeSelection(), s3Client, new(ec2.TransitGatewayPeeringAttachment))
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
	...
	var endObject *ec2.TransitGatewayPeeringAttachment
	endS3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "ec2", "transit_gateway_peering_attachments"}, *params.EndReportDate, params.GetRequestEndTimeSelection(), s3Client, new(ec2.TransitGatewayPeeringAttachment))
	if err != nil {
		c.AbortWithStatusJSON(500, gin.H{"error": err.Error()})
		return
