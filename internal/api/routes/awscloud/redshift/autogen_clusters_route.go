...
func GetClustersMetadata(c *gin.Context, s3Client *awsS3.Client, s3Bucket string) {
	...
	s3DirReader, err := indexedstorage.NewParquetS3DirectoryReader(c.Request.Context(), s3Bucket, []string{"aws", "redshift", "clusters"}, reportDate, indexedstorage.RequestTimeSelection{}, s3Client, new(redshift.Cluster))
	if err != nil {
