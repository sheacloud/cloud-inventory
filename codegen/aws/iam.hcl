aws_service "iam" {
  ...
  resource "groups" {
    ...
    child {
      object_source_name = "AttachedPolicy"
  ...
  resource "users" {
    ...
    child {
      object_source_name = "AccessKeyMetadata"
    ...
    child {
      object_source_name = "LoginProfile"
