aws_service "s3" {
  ...
  resource "buckets" {
    ...
    child {
      object_source_name = "ReplicationConfiguration"
    ...
    // GetBucketEncryption
    child {
      object_source_name = "ServerSideEncryptionConfiguration"
    ...
    child {
      object_source_name = "IntelligentTieringConfiguration"
    ...
    child {
      object_source_name = "InventoryConfiguration"
    ...
    child {
      object_source_name = "LifecycleRule"
    ...
    // GetBucketLogging
    child {
      object_source_name = "LoggingEnabled"
