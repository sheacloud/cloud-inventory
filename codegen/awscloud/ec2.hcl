aws_service "ec2" {
  ...
  resource "dhcp_options" {
    ...
    object_source_name    = "DhcpOptions"
  ...
  #   object_source_name    = "InstanceTypeInfo"
  ...
  resource "internet_gateways" {
    ...
    object_source_name    = "InternetGateway"
  ...
  resource "managed_prefix_lists" {
    ...
    object_source_name    = "ManagedPrefixList"
  ...
  resource "network_interfaces" {
    ...
    object_source_name    = "NetworkInterface"
  ...
  resource "placement_groups" {
    ...
    object_source_name    = "PlacementGroup"
  ...
  resource "reserved_instances" {
    ...
    object_source_name    = "ReservedInstances"
  ...
  resource "security_groups" {
    ...
    object_source_name    = "SecurityGroup"
  ...
  resource "transit_gateway_peering_attachments" {
    ...
    object_source_name    = "TransitGatewayPeeringAttachment"
  ...
  resource "transit_gateway_route_tables" {
    ...
    object_source_name    = "TransitGatewayRouteTable"
  ...
  resource "transit_gateway_vpc_attachments" {
    ...
    object_source_name    = "TransitGatewayVpcAttachment"
  ...
  resource "transit_gateways" {
    ...
    object_source_name    = "TransitGateway"
  ...
  resource "vpc_endpoints" {
    ...
    object_source_name    = "VpcEndpoint"
  ...
  resource "vpc_peering_connections" {
    ...
    object_source_name    = "VpcPeeringConnection"
